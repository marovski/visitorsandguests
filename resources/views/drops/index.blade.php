...
@section('content')
	...
	<div class="col-md-2">
			<a href="{{ route('drops.create') }}" class="btn btn-lg btn-block btn-primary btn-h1-spacing">New Drop</a>
		</div>
		<div class="col-md-12">
			<hr>
		</div>
                    ...
                    <tbody>
                        @foreach($drops as $drop )
                            <tr>
                                ...
                                <a href="{{ route('drops.show',$drop->idDrop) }}" class="btn btn-default btn-sm">Check-out</a>
                                @else <a href="{{ route('drops.show',$drop->idDrop) }}" disabled="disabled" class="btn btn-default btn-sm">Check-out</a>
                                @endif
                                <a href="{{ route('drops.view',$drop->idDrop) }}" class="btn btn-default btn-sm">View</a>
