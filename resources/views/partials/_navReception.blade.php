...
<li class="{{ Request::is('dashboard') ? "active" : "" }}"><a href="/dashboard"><span class="glyphicon glyphicon-dashboard"></span> Dashboards</a></li>
...
<li><a href="{{ route('losts.index') }}"><span class="glyphicon glyphicon-gift"></span> Lost/Found</a></li>
